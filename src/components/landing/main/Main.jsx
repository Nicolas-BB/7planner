        ...
        <main className={styles.main}>
            ...
            <section className={styles.tagsSection}>
                <div className={styles.infoDiv}>
                    ...
                    <img src={tags} alt="Tags" className={`${styles.tagsImg} ${styles.animatedImg}`} />
                </div>
            </section>
            <section className={styles.weekSection}>
                <div className={styles.infoDiv}>
                    ...
                    <img src={week} alt="Week" className={`${styles.weekImg} ${styles.animatedImg}`} />
                </div>
            </section>
            <section className={styles.geminiSection}>
                <div className={styles.infoDiv}>
                    ...
                    <img src={gemini} alt="Gemini" className={`${styles.geminiImg} ${styles.animatedImg}`} />
                </div>
            </section>
